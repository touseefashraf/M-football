...
@Component({
    selector: 'app-coaching-tips',
    templateUrl: './coaching-tips.component.html',
    styleUrls: ['./coaching-tips.component.css']
})
export class CoachingTipsComponent implements OnInit {
    tourForm: FormGroup
    tourId: any
    tourDetailList: any = []
    dataStatus = 'fetching'
