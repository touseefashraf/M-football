...
export class AddeditComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.newsForm = this.fb.group({
            ...
            tournament_type: new FormControl('trip', [Validators.required]),
    ...
    save(data: any, f: any) {
        ...
        data.value.tournament_type='trip'
        ...
        saveMethod.subscribe((resp: any) => {
            ...
            if (resp.success === false) {
                ...
                if (this.dataService.selectedId > '-1') {
                    ...
                    this.router.navigate(['/admin/trip/publish'], { queryParams: { id: data.value.id }, replaceUrl: true })
                    ...
                    this.dataService.step = 2
                    this.router.navigate(['/admin/trip/publish'], { queryParams: { id: resp.data }, replaceUrl: true })
                }
            }
        })
