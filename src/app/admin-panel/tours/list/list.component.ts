...
export class List implements OnInit {
    ...
    getList() {
        ...
        this.dataService.list(params).subscribe((resp: any) => {
            if (resp.success === true) {
                ...
                this.pagination = resp.data
                this.fetching = false
                this.router.navigate(['/admin/tours/list'], { queryParams: params, replaceUrl: true })
            }
        })
    }
    setPagination(page: number) {
        ...
        this.router.navigate(['/admin/tours/list'], { queryParams: filtersParam, replaceUrl: true })
    }
    ...
    edit(id: number) {
        this.router.navigateByUrl(`/${this.api.user.user_type}/tours/publish?id=${id}`)
    }


    add() {
        this.router.navigateByUrl(`/${this.api.user.user_type}/tours/publish?id=-1`)
    }
