    ...
    save() {
        ...
        fetch(this.thumbnail)
            ...
            .then(blob => {
                ...
                formData.append('start_date', moment(this.dataService.newsDetails.start_date).format('YYYY-MM-DD'))
                formData.append('end_date', moment(this.dataService.newsDetails.end_date).format('YYYY-MM-DD'))
                formData.append('born_after', moment(this.dataService.newsDetails.end_date).format('YYYY-MM-DD'))
                ...
                formData.append('highlights', this.dataService.newsDetails.highlights)
